    ...
    <div className="pet-page page-enter">
      ...
      <div className="pet-layout">
        <section className="pet-display-card">
          <div className="pet-display-bg"><span className="pet-display-sun" /><span className="pet-display-leaf">♧</span><Mascot coat={coat} gender={pet.gender} personality={personality} size="xl" state="happy" /><div className="equipped-bandana">{pet.gender === 'female' ? 'Visual: laço rosa queimado' : 'Visual: gravata marrom'}</div></div>
